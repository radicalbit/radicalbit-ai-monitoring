...
export default function confusionMatrixOptions(dataset, labelClass, colors) {
  ...
  const options = {
    ...commonChartOptions.yAxisOptions(OPTIONS_TYPE.CATEGORY, labelClass.yAxisLabel),
    ...commonChartOptions.xAxisOptions(OPTIONS_TYPE.CATEGORY, labelClass.xAxisLabel),
    ...
    series: {
      ...commonChartOptions.seriesOptions(CHART_TYPE.HEATMAP, heatmapData),
    },
  };
